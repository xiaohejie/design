...
def plot_history_curcvs(history, save_path, model_name):
    ...
    :return:
    '''
    print('plot_history_curcvs start')
    ...
    # print('plot_history_curcvs start start')
    epochs = range(len(acc))
    # print('plot_history_curcvs start start start')
    ...
    # print('plt start start')
    # plt.show()
    # print('plt start start start')
    plt.close()
...
def plot_metrics(model, model_name, save_path, X_test, y_test):
    ...
    skplt.metrics.plot_roc(y_test, y_probas
                           , title=model_name+' ROC Curves', figsize=(7, 7),
    ...
    skplt.metrics.plot_precision_recall(y_test, y_probas
                                        , title=model_name+' Precision-Recall Curves', figsize=(7, 7),
                                        # title_fontsize = 24, text_fontsize = 16
                                        )
