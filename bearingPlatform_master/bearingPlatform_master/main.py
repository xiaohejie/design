...
class MainWindow(QMainWindow):
    ...
    def init_UI(self):
        ...
        self.ui.pb_visual_data.clicked.connect(self.visual_data)    # 模型训练页面下的 数据可视化 按钮
        self.ui.pb_start_training.clicked.connect(self.start_training)  # 模型训练页面下的 开始训练 按钮
