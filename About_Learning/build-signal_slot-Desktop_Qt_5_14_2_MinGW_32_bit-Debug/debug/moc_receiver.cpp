...
#include <memory>
#include "../../qt-signal-slot-master/receiver.h"
...
QT_MOC_LITERAL(4, 26, 14) // "receiveFromQml"
    ...
    "Receiver\0sendToQml\0\0count\0receiveFromQml"
};
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveFromQml((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Receiver::sendToQml)) {
                *result = 0;
                return;
            }
        }
