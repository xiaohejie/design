...
void BaseFlowers::addFlowers(QString flowerType, QString plantTime, QString farming, QString nongzi, QString location1, QString location2, QString location3, QString location4, QString company, QString contactPerson, QString contactNum, QString quantity, QString costperPlant, QString userName, QString remark)
{
    ...
    QSqlQuery query;
    QString sql = "SELECT MAX(id) FROM plant_info; ";
    query.prepare(sql);
    query.exec();
    if(query.next()){
    ...
    sql = "insert into plant_info(id,type, plantTime, farming, nongzi, location1, location2, location3, location4, company, contactPerson, contactNum, quantity, costperPlant, cost, operator, fertilization, watering, growth, remark) "
    ...
    /*   query.prepare("insert into plant_info(type, plantTime, farming, nongzi, location1, location2, location3, location4, company, contactPerson, contactNum, quantity, costperPlant, cost, operator, fertilization, watering, growth, remark)"
