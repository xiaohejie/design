...
void myWatch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<myWatch *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (myWatch::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myWatch::maxChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myWatch::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_myWatch.data,
    qt_meta_data_myWatch,
    qt_static_metacall,
    nullptr,
    nullptr
} };
