...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DATestPage_t, stringdata0) + ofs \
...
static const uint qt_meta_data_DATestPage[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Char, QMetaType::SChar,   10,
...
void DATestPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DATestPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 5: { char _r = _t->back_translate((*reinterpret_cast< signed char(*)>(_a[1])));
...
QT_INIT_METAOBJECT const QMetaObject DATestPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DATestPage.data,
    qt_meta_data_DATestPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DATestPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DATestPage.stringdata0))
