...
void Page_1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Page_1::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Page_1::changeTorsion)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Page_1::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Page_1::changeSpeed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Page_1::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Page_1::changePower)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Page_1::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Page_1::getTestData)) {
                *result = 3;
                return;
            }
        }
