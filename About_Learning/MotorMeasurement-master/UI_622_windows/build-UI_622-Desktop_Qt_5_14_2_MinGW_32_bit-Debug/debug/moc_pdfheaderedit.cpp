...
void pdfHeaderEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pdfHeaderEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject pdfHeaderEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_pdfHeaderEdit.data,
    qt_meta_data_pdfHeaderEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
