...
#include <memory>
#include "../../../signALib/SAValueManagerModel.h"
...
void SAValueManagerModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAValueManagerModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAValueManagerModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_SAValueManagerModel.data,
    qt_meta_data_SAValueManagerModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
