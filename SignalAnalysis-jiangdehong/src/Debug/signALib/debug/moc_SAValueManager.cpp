...
#include <memory>
#include "../../../signALib/SAValueManager.h"
...
void SAValueManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAValueManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAValueManager::*)(const QString & , SA::MeaasgeType );
        ...
        {
            using _t = void (SAValueManager::*)(SAAbstractDatas * , const QString & );
        ...
        {
            using _t = void (SAValueManager::*)(const QList<SAAbstractDatas*> & );
...
QT_INIT_METAOBJECT const QMetaObject SAValueManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SAValueManager.data,
    qt_meta_data_SAValueManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
