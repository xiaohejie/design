...
#include <memory>
#include "../../../signACommonUI/Chart2D/SASelectRegionDataEditor.h"
...
void SASelectRegionDataEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SASelectRegionDataEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SASelectRegionDataEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<SAAbstractPlotEditor::staticMetaObject>(),
    qt_meta_stringdata_SASelectRegionDataEditor.data,
    qt_meta_data_SASelectRegionDataEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
