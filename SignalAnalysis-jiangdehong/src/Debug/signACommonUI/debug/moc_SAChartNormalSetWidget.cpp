...
#include <memory>
#include "../../../signACommonUI/figureSet/SAChartNormalSetWidget.h"
...
void SAChartNormalSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAChartNormalSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAChartNormalSetWidget::*)(SAChart2D * , const QString & );
...
QT_INIT_METAOBJECT const QMetaObject SAChartNormalSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAChartNormalSetWidget.data,
    qt_meta_data_SAChartNormalSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
