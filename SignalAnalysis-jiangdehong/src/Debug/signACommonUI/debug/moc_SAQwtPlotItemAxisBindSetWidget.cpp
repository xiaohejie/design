...
#include <memory>
#include "../../../signACommonUI/figureSet/SAQwtPlotItemAxisBindSetWidget.h"
...
void SAQwtPlotItemAxisBindSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAQwtPlotItemAxisBindSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAQwtPlotItemAxisBindSetWidget::*)(int , int );
...
QT_INIT_METAOBJECT const QMetaObject SAQwtPlotItemAxisBindSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAQwtPlotItemAxisBindSetWidget.data,
    qt_meta_data_SAQwtPlotItemAxisBindSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
