...
#include <memory>
#include "../../../signACommonUI/figureSet/SAQwtPlotCurveItemSetWidget.h"
...
void SAQwtPlotCurveItemSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAQwtPlotCurveItemSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAQwtPlotCurveItemSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<SAQwtPlotItemSetWidget::staticMetaObject>(),
    qt_meta_stringdata_SAQwtPlotCurveItemSetWidget.data,
    qt_meta_data_SAQwtPlotCurveItemSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
