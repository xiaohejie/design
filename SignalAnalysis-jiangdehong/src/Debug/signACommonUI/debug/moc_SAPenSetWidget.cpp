...
#include <memory>
#include "../../../signACommonUI/SAPenSetWidget.h"
...
void SAPenSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAPenSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAPenSetWidget::*)(const QPen & );
...
QT_INIT_METAOBJECT const QMetaObject SAPenSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAPenSetWidget.data,
    qt_meta_data_SAPenSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
