...
#include <memory>
#include "../../../signACommonUI/SAProjectManager.h"
...
void SAProjectManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAProjectManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAProjectManager::*)(const QString & , SA::MeaasgeType );
        ...
        {
            using _t = void (SAProjectManager::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject SAProjectManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SAProjectManager.data,
    qt_meta_data_SAProjectManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
