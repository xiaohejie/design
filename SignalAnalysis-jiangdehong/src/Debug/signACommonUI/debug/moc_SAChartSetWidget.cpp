...
#include <memory>
#include "../../../signACommonUI/SAChartSetWidget.h"
...
void SAChartSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAChartSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAChartSetWidget::*)(SAChart2D * , const QString & );
...
QT_INIT_METAOBJECT const QMetaObject SAChartSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAChartSetWidget.data,
    qt_meta_data_SAChartSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
