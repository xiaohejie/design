...
#include <memory>
#include "../../../signACommonUI/SAMainWindow.h"
...
void SAMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAMainWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAMainWindow::*)(SAMainWindow * );
...
QT_INIT_METAOBJECT const QMetaObject SAMainWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_SAMainWindow.data,
    qt_meta_data_SAMainWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
