...
#include <memory>
#include "../../../signACommonUI/SAMdiSubWindow.h"
...
void SAMdiSubWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAMdiSubWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAMdiSubWindow::*)(SAMdiSubWindow * );
...
QT_INIT_METAOBJECT const QMetaObject SAMdiSubWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMdiSubWindow::staticMetaObject>(),
    qt_meta_stringdata_SAMdiSubWindow.data,
    qt_meta_data_SAMdiSubWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
