...
#include <memory>
#include "../../../signACommonUI/SAPropertySetWidget.h"
...
void SAPropertySetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAPropertySetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAPropertySetWidget::*)(QtProperty * , const QVariant & );
...
QT_INIT_METAOBJECT const QMetaObject SAPropertySetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAPropertySetWidget.data,
    qt_meta_data_SAPropertySetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
