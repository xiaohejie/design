...
#include <memory>
#include "../../../signACommonUI/SAPropertyItem/SAComboBoxPropertyItem.h"
...
void SAComboBoxPropertyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAComboBoxPropertyItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAComboBoxPropertyItem::*)(int );
        ...
        {
            using _t = void (SAComboBoxPropertyItem::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SAComboBoxPropertyItem::currentIndexChanged)) {
                *result = 1;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject SAComboBoxPropertyItem::staticMetaObject = { {
    QMetaObject::SuperData::link<SAPropertyItemContainer::staticMetaObject>(),
    qt_meta_stringdata_SAComboBoxPropertyItem.data,
    qt_meta_data_SAComboBoxPropertyItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
