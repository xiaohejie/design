...
#include <memory>
#include "../../../signACommonUI/SAPropertyItem/SAFontComboBoxPropertyItem.h"
...
void SAFontComboBoxPropertyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAFontComboBoxPropertyItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAFontComboBoxPropertyItem::*)(const QFont & );
...
QT_INIT_METAOBJECT const QMetaObject SAFontComboBoxPropertyItem::staticMetaObject = { {
    QMetaObject::SuperData::link<SAPropertyItemContainer::staticMetaObject>(),
    qt_meta_stringdata_SAFontComboBoxPropertyItem.data,
    qt_meta_data_SAFontComboBoxPropertyItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
