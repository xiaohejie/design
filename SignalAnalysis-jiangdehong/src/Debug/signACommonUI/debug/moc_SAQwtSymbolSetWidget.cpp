...
#include <memory>
#include "../../../signACommonUI/figureSet/SAQwtSymbolSetWidget.h"
...
void SAQwtSymbolSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAQwtSymbolSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAQwtSymbolSetWidget::*)(const QwtSymbol & );
...
QT_INIT_METAOBJECT const QMetaObject SAQwtSymbolSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAQwtSymbolSetWidget.data,
    qt_meta_data_SAQwtSymbolSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
