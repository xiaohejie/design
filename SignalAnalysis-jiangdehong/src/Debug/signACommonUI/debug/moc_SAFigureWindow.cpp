...
#include <memory>
#include "../../../signACommonUI/Chart2D/SAFigureWindow.h"
...
void SAFigureWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAFigureWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAFigureWindow::*)(QwtPlot * );
        ...
        {
            using _t = void (SAFigureWindow::*)(QWidget * );
...
QT_INIT_METAOBJECT const QMetaObject SAFigureWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<SAMainWindow::staticMetaObject>(),
    qt_meta_stringdata_SAFigureWindow.data,
    qt_meta_data_SAFigureWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
