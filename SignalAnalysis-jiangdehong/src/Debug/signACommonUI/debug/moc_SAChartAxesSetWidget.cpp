...
#include <memory>
#include "../../../signACommonUI/figureSet/SAChartAxesSetWidget.h"
...
void SAChartAxesSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAChartAxesSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAChartAxesSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAChartAxesSetWidget.data,
    qt_meta_data_SAChartAxesSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
