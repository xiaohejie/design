...
#include <memory>
#include "../../../signACommonUI/SAPropertyItem/SAColorSetPropertyItem.h"
...
void SAColorSetPropertyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAColorSetPropertyItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAColorSetPropertyItem::*)(const QColor & );
...
QT_INIT_METAOBJECT const QMetaObject SAColorSetPropertyItem::staticMetaObject = { {
    QMetaObject::SuperData::link<SAPropertyItemContainer::staticMetaObject>(),
    qt_meta_stringdata_SAColorSetPropertyItem.data,
    qt_meta_data_SAColorSetPropertyItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
