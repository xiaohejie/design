...
#include <memory>
#include "../../../signACommonUI/SAQwtSymbolComboBox.h"
...
void SAQwtSymbolComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAQwtSymbolComboBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAQwtSymbolComboBox::*)(QwtSymbol::Style );
...
QT_INIT_METAOBJECT const QMetaObject SAQwtSymbolComboBox::staticMetaObject = { {
    QMetaObject::SuperData::link<SymbolBox::staticMetaObject>(),
    qt_meta_stringdata_SAQwtSymbolComboBox.data,
    qt_meta_data_SAQwtSymbolComboBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
