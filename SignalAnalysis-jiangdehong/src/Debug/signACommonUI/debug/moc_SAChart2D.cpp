...
#include <memory>
#include "../../../signACommonUI/Chart2D/SAChart2D.h"
...
void SAChart2D::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAChart2D *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAChart2D::*)(const QPainterPath & );
        ...
        {
            using _t = void (SAChart2D::*)(const QList<QwtPlotItem*> & );
        ...
        {
            using _t = void (SAChart2D::*)(SelectionMode , bool );
...
QT_INIT_METAOBJECT const QMetaObject SAChart2D::staticMetaObject = { {
    QMetaObject::SuperData::link<SA2DGraph::staticMetaObject>(),
    qt_meta_stringdata_SAChart2D.data,
    qt_meta_data_SAChart2D,
    qt_static_metacall,
    nullptr,
    nullptr
} };
