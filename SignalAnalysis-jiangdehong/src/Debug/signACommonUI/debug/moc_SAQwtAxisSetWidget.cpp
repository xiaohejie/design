...
#include <memory>
#include "../../../signACommonUI/figureSet/SAQwtAxisSetWidget.h"
...
void SAQwtAxisSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAQwtAxisSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAQwtAxisSetWidget::*)(bool , int );
...
QT_INIT_METAOBJECT const QMetaObject SAQwtAxisSetWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAQwtAxisSetWidget.data,
    qt_meta_data_SAQwtAxisSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
