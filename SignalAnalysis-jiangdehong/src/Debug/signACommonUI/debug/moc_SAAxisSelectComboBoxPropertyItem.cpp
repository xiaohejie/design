...
#include <memory>
#include "../../../signACommonUI/figureSet/SAAxisSelectComboBoxPropertyItem.h"
...
void SAAxisSelectComboBoxPropertyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAAxisSelectComboBoxPropertyItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAAxisSelectComboBoxPropertyItem::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject SAAxisSelectComboBoxPropertyItem::staticMetaObject = { {
    QMetaObject::SuperData::link<SAComboBoxPropertyItem::staticMetaObject>(),
    qt_meta_stringdata_SAAxisSelectComboBoxPropertyItem.data,
    qt_meta_data_SAAxisSelectComboBoxPropertyItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
