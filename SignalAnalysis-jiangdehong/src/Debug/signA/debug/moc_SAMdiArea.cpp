...
#include <memory>
#include "../../../signA/mainWindows/SAMdiArea.h"
...
void SAMdiArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAMdiArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAMdiArea::*)(SAMdiSubWindow * );
...
QT_INIT_METAOBJECT const QMetaObject SAMdiArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QMdiArea::staticMetaObject>(),
    qt_meta_stringdata_SAMdiArea.data,
    qt_meta_data_SAMdiArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
