...
#include <memory>
#include "../../../signA/View/hardwarewindow.h"
...
void HardwareWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HardwareWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject HardwareWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_HardwareWindow.data,
    qt_meta_data_HardwareWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
