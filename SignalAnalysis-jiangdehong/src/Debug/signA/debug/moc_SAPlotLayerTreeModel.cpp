...
#include <memory>
#include "../../../signA/model/SAPlotLayerTreeModel.h"
...
void SAPlotLayerTreeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAPlotLayerTreeModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAPlotLayerTreeModel::*)();
...
QT_INIT_METAOBJECT const QMetaObject SAPlotLayerTreeModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_SAPlotLayerTreeModel.data,
    qt_meta_data_SAPlotLayerTreeModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
