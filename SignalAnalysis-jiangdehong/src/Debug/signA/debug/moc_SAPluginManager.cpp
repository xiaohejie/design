...
#include <memory>
#include "../../../signA/SAPluginManager.h"
...
void SAPluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAPluginManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAPluginManager::*)(const QString & , SA::MeaasgeType );
...
QT_INIT_METAOBJECT const QMetaObject SAPluginManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SAPluginManager.data,
    qt_meta_data_SAPluginManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
