...
#include <memory>
#include "../../../signA/RedisTools/qtredis.h"
...
void QtRedis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QtRedis *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QtRedis::*)(QtRedis::Reply );
...
QT_INIT_METAOBJECT const QMetaObject QtRedis::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QtRedis.data,
    qt_meta_data_QtRedis,
    qt_static_metacall,
    nullptr,
    nullptr
} };
