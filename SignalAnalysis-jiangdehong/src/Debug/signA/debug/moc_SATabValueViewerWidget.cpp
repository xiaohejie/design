...
#include <memory>
#include "../../../signA/SATabValueViewerWidget.h"
...
void SATabValueViewerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SATabValueViewerWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SATabValueViewerWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QTabWidget::staticMetaObject>(),
    qt_meta_stringdata_SATabValueViewerWidget.data,
    qt_meta_data_SATabValueViewerWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
