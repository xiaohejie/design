...
#include <memory>
#include "../../../signA/dialog/SAAddLineChartSetDialog.h"
...
void SAAddLineChartSetDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAAddLineChartSetDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAAddLineChartSetDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_SAAddLineChartSetDialog.data,
    qt_meta_data_SAAddLineChartSetDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
