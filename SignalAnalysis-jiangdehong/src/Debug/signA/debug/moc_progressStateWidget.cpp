...
#include <memory>
#include "../../../signA/progressStateWidget.h"
...
void progressStateWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<progressStateWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject progressStateWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_progressStateWidget.data,
    qt_meta_data_progressStateWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
