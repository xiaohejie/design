...
void SADataClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SADataClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SADataClient::*)(const QString & , SA::MeaasgeType );
        ...
        {
            using _t = void (SADataClient::*)(bool );
        ...
        {
            using _t = void (SADataClient::*)(int );
        ...
        {
            using _t = void (SADataClient::*)(const SAPropertiesGroup & , int , unsigned int );
        ...
        {
            using _t = void (SADataClient::*)(const QVector<QPointF> & , int , int );
...
QT_INIT_METAOBJECT const QMetaObject SADataClient::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SADataClient.data,
    qt_meta_data_SADataClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
