...
#include <memory>
#include "../../../signA/View/OpenDataFileDialog.h"
...
QT_MOC_LITERAL(5, 59, 20), // "on_tableView_clicked"
QT_MOC_LITERAL(6, 80, 25) // "on_pushButtonOpen_clicked"

    },
    "OpenDataFileDialog\0on_tableView_pressed\0"
    "\0QModelIndex\0index\0on_tableView_clicked\0"
...
void OpenDataFileDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OpenDataFileDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject OpenDataFileDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_OpenDataFileDialog.data,
    qt_meta_data_OpenDataFileDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
