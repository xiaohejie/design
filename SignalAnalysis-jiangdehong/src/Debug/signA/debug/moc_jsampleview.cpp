...
#include <memory>
#include "../../../signA/View/jsampleview.h"
...
void JSampleView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<JSampleView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject JSampleView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_JSampleView.data,
    qt_meta_data_JSampleView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
