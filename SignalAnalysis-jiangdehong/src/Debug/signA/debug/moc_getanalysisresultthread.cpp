...
#include <memory>
#include "../../../signA/Utils/getanalysisresultthread.h"
...
void GetAnalysisResultThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GetAnalysisResultThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GetAnalysisResultThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_GetAnalysisResultThread.data,
    qt_meta_data_GetAnalysisResultThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
