...
#include <memory>
#include "../../../signA/Utils/PlayBackThread.h"
...
void SumPlayBackThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SumPlayBackThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SumPlayBackThread::*)();
...
QT_INIT_METAOBJECT const QMetaObject SumPlayBackThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_SumPlayBackThread.data,
    qt_meta_data_SumPlayBackThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
