...
#include <memory>
#include "../../../signA/widget/SAMessageWidget.h"
...
void SAMessageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAMessageWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAMessageWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SAMessageWidget.data,
    qt_meta_data_SAMessageWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
