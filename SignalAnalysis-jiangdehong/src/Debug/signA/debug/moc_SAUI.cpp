...
QT_INIT_METAOBJECT const QMetaObject SAUI::staticMetaObject = { {
    QMetaObject::SuperData::link<SAUIInterface::staticMetaObject>(),
    qt_meta_stringdata_SAUI.data,
    qt_meta_data_SAUI,
    qt_static_metacall,
    nullptr,
    nullptr
