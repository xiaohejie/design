...
#include <memory>
#include "../../../../signAPlugin/TextImport/CheckedHeaderView.h"
...
void CheckedHeaderView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CheckedHeaderView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CheckedHeaderView::*)(int , bool );
...
QT_INIT_METAOBJECT const QMetaObject CheckedHeaderView::staticMetaObject = { {
    QMetaObject::SuperData::link<QHeaderView::staticMetaObject>(),
    qt_meta_stringdata_CheckedHeaderView.data,
    qt_meta_data_CheckedHeaderView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
