...
#include <memory>
#include "../../../../signAPlugin/FunPlugin/SATimeFrequencyAnalysis.h"
...
void SATimeFrequencyAnalysis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SATimeFrequencyAnalysis *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SATimeFrequencyAnalysis::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SATimeFrequencyAnalysis.data,
    qt_meta_data_SATimeFrequencyAnalysis,
    qt_static_metacall,
    nullptr,
    nullptr
} };
