...
#include <memory>
#include "../../../../signAPlugin/FunPlugin/SAFunPlugin.h"
...
void SAFunPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAFunPlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAFunPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SAFunPlugin.data,
    qt_meta_data_SAFunPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
