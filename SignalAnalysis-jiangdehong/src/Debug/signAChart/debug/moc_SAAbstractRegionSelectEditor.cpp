...
#include <memory>
#include "../../../signAChart/SAAbstractRegionSelectEditor.h"
...
void SAAbstractRegionSelectEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAAbstractRegionSelectEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SAAbstractRegionSelectEditor::*)(const QPainterPath & );
...
QT_INIT_METAOBJECT const QMetaObject SAAbstractRegionSelectEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<SAAbstractPlotEditor::staticMetaObject>(),
    qt_meta_stringdata_SAAbstractRegionSelectEditor.data,
    qt_meta_data_SAAbstractRegionSelectEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
