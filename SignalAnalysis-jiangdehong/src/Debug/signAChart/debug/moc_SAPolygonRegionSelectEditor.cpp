...
#include <memory>
#include "../../../signAChart/SAPolygonRegionSelectEditor.h"
...
void SAPolygonRegionSelectEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAPolygonRegionSelectEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAPolygonRegionSelectEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<SAAbstractRegionSelectEditor::staticMetaObject>(),
    qt_meta_stringdata_SAPolygonRegionSelectEditor.data,
    qt_meta_data_SAPolygonRegionSelectEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
