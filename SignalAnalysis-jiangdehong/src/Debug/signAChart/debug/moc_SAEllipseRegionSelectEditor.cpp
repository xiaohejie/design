...
#include <memory>
#include "../../../signAChart/SAEllipseRegionSelectEditor.h"
...
void SAEllipseRegionSelectEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAEllipseRegionSelectEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAEllipseRegionSelectEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<SAAbstractRegionSelectEditor::staticMetaObject>(),
    qt_meta_stringdata_SAEllipseRegionSelectEditor.data,
    qt_meta_data_SAEllipseRegionSelectEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
