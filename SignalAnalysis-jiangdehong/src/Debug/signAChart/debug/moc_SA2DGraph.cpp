...
#include <memory>
#include "../../../signAChart/SA2DGraph.h"
...
QT_INIT_METAOBJECT const QMetaObject Zoomer_qwt::staticMetaObject = { {
    QMetaObject::SuperData::link<ScrollZoomer::staticMetaObject>(),
    qt_meta_stringdata_Zoomer_qwt.data,
    qt_meta_data_Zoomer_qwt,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SA2DGraph *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SA2DGraph::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtPlot::staticMetaObject>(),
    qt_meta_stringdata_SA2DGraph.data,
    qt_meta_data_SA2DGraph,
    qt_static_metacall,
    nullptr,
    nullptr
} };
