...
void MainWindow::initUI()
{
    ...
    //-------------------------------------
    //- value operate
    connect(ui->actionImport, &QAction::triggered, this, &MainWindow::onActionValueCreateWizardTriggered);
    connect(ui->actionExport, &QAction::triggered, this, &MainWindow::onActionValueCreateDoubleVectorTriggered);
    connect(ui->actionsystemEport, &QAction::triggered, this, &MainWindow::onActionValueCreatePointVectorTriggered);
    connect(ui->actionsystemImport, &QAction::triggered, this, &MainWindow::onActionValueCreateVariantTableTriggered);
    //-------------------------------------
